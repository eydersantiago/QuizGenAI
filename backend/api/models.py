...
class GenerationSession(models.Model):
    ...
    # Cantidad de preguntas que deben tener imagenes por tipo
    image_counts = models.JSONField(default=dict, help_text="Cantidad de preguntas con imagen por tipo, ej: {'mcq':2,'vf':1}")
